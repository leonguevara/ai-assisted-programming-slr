...
In addition to the initial AI-assisted retrieval process conducted through SciSpace, complementary searches were performed iteratively using traditional academic databases (e.g., Scopus, ProQuest, IEEE Xplore) to ensure broader coverage and reduce the risk of missing relevant studies. This hybrid approach reflects a pragmatic combination of AI-assisted discovery and conventional systematic search practices.
...
During the screening process, a subset of studies initially excluded at the abstract stage was re-evaluated through full-text analysis. This was necessary to mitigate limitations of abstract-level filtering, particularly for studies that addressed code quality, benchmarking, or system-level evaluation without explicitly reporting productivity-related outcomes in their abstracts. As a result, selected studies were reintegrated into the analysis following consistent inclusion criteria.
...
Economic impact represents 9.4\% of the corpus and remains comparatively underexplored. Most available studies rely on model-based analyses or limited case studies, with relatively scarce large-scale empirical evaluations \cite{rodriguez_comparative_2025}.
...
For instance, productivity gains are more pronounced among less experienced developers, while experienced developers may incur additional costs related to supervision and quality assurance. Moreover, some studies identify threshold effects, indicating that AI adoption becomes economically viable only beyond certain levels of workload or development intensity \cite{rodriguez_comparative_2025}.
...
Moreover, economic impact appears to be highly context-dependent. Factors such as team structure, developer experience, and workload intensity play a critical role in determining whether AI adoption results in net gains or increased costs \cite{rodriguez_comparative_2025, song_impact_2024}.
